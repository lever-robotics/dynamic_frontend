	...
	return (
		<div className="p-4 max-w-4xl mx-auto">
			...
			{displayState.toolExecutions.length > 0 && (
				<div className="mb-4">
					<ToolStateDisplay
						toolStates={displayState.toolExecutions.map((exec) => ({
							tool: exec.tool,
			...
			{displayState.finalResponse && (
				<div className="p-4 bg-white rounded shadow">
					<pre className="whitespace-pre-wrap">
						{displayState.finalResponse.text}
					</pre>
					{displayState.finalResponse.metadata && (
						<div className="mt-4 text-sm text-gray-600">
							<p>
								Processing Time:{" "}
								{displayState.finalResponse.metadata.processingTime}ms
							</p>
							{displayState.finalResponse.metadata.tokensUsed > 0 && (
								<p>
									Tokens Used: {displayState.finalResponse.metadata.tokensUsed}
								</p>
							)}
						</div>
					)}
