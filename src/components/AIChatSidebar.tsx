...
// 													? ("error" as ToolExecutionStatus)
// 													: ("completed" as ToolExecutionStatus),
// 											},
// 										};
// 									}
// 									return segment;
...
// 				);
// 			}
// 			if (segment.type === "tool" && segment.toolExecution) {
...
// 					<div
// 						key={segmentIndex}
// 						className="my-4 rounded-lg overflow-hidden border border-gray-200 shadow-sm"
// 					>
// 						{/* Tool Status Header */}
// 						<div
...
// 								<span className="text-sm">{tool.isExpanded ? "▼" : "▶"}</span>
// 							</div>
// 						</div>
...
// 							<div
// 								className={`${tool.error ? "bg-red-50" : "bg-green-50"} p-4 border-t border-gray-200`}
// 							>
// 								<div
// 									className={`font-medium ${tool.error ? "text-red-700" : "text-green-700"} mb-2`}
// 								>
// 									{tool.error ? "Error" : "Response"}
// 								</div>
// 								<pre
// 									className={`bg-white p-3 rounded overflow-x-auto border ${tool.error ? "border-red-100" : "border-green-100"}`}
// 								>
// 									<code
// 										className={`text-sm ${tool.error ? "text-red-800" : "text-green-800"} whitespace-pre-wrap`}
// 									>
// 										{(() => {
// 											const responseText =
...
// 				<div
// 					className={`flex items-center ${isConnected ? "text-green-600" : "text-yellow-600"}`}
// 				>
// 					<div
// 						className={`w-2 h-2 rounded-full mr-2 ${isConnected ? "bg-green-600" : "bg-yellow-600"}`}
// 					/>
...
// 					<div
// 						key={msgIndex}
// 						className="mb-4 border-t border-gray-200 pt-4 first:border-t-0"
// 					>
// 						{msg.type === "user" ? (
