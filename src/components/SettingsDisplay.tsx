			...
			<div className="flex flex-col gap-6">
				...
				<div className="flex flex-col gap-4">
					{settings.map((setting) => (
						...
						>
							<div>
								<h3 className="font-medium text-neutral-900">{setting.name}</h3>
				...
				<div className="mt-auto pt-6 border-t border-gray-200 flex flex-col gap-4">
					...
					<button
						...
						className="w-2/4 mx-auto flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
					>
						Onboarding
					</button>
					{/* <button
